  ...
  <div class="flex h-screen">
    ...
    <div class="w-full bg-white lg:w-1/2 flex items-center justify-center">
      <div class="max-w-md w-full p-6">
        <h1 class="text-3xl font-semibold mb-6 text-blue-900 text-center">Login</h1>
        ...
        <div class="mt-4 text-sm text-gray-600 text-center">
          <p>
            ...
            <NuxtLink to="/signup" class="text-blue-600 hover:underline font-medium">
              Sign up here
            </NuxtLink>
          </p>
        </div>
...
const handleSubmit = () => {
  navigateTo('/admin')  // Add your login logic here
}
</script>
