...
async function initMap() {
    ...
    try {
        ...
        // If editing and has coordinates
        if (form.latitude && form.longitude) {
            const latLng: LatLngExpression = [form.latitude, form.longitude];
...
async function fetchPerusahaan() {
    ...
    try {
        ...
        if (response.success && response.data) {
            ...
            form.nama_perusahaan = response.data.nama_perusahaan || "";
            // Detail alamat
            form.jalan = response.data.jalan || "";
            form.desa = response.data.desa || "";
            form.kecamatan = response.data.kecamatan || "";
            form.kelurahan = response.data.kelurahan || "";
            form.kabupaten_kota = response.data.kabupaten_kota || "";
            form.provinsi = response.data.provinsi || "";
            form.kode_pos = response.data.kode_pos || "";
            // Kontak
            form.no_hp = response.data.no_hp || "";
            form.email = response.data.email || "";
            // Info perusahaan
            form.bidang_usaha = response.data.bidang_usaha || "";
            form.kapasitas_siswa = response.data.kapasitas_siswa || 10;
            // Koordinat
...
async function handleSubmit() {
    ...
    try {
        ...
        const response = await perusahaanApi.update(id.value, payload);
...
useHead({ title: "Edit Perusahaan | Admin" });
</script>
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div>
                ...
                <p class="text-sm text-slate-500 mt-0.5">
                    Perbarui data perusahaan mitra
                </p>
            </div>
        </div>
                ...
                >
                    ...
                    <div class="p-5 space-y-4">
                        <p class="text-sm text-slate-500">
                            Klik pada peta untuk mengubah lokasi dan mengisi
