<template>
    <div class="space-y-6 max-w-[1600px] mx-auto pb-10">
        ...
        >
            <div>
                ...
                <p class="text-sm text-slate-500 font-medium tracking-tight">
                    Kelola dan arsipkan surat masuk administrasi sekolah
                </p>
            </div>
            <UButton
                color="success"
        ...
        <div
            class="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm transition-all duration-300"
        >
            <div
            ...
            >
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2
                            class="text-sm font-bold text-blue-900 uppercase tracking-wider"
                        >
                            Panel Pencarian & Cetak Data
                        </h2>
                        <p class="text-xs text-slate-500 font-medium">
                            Filter data surat masuk untuk cetak atau laporan
                        </p>
                    </div>
                </div>
                <Icon
            ...
            >
                <div v-show="isSearchPanelExpanded" class="p-6 space-y-6">
                    ...
                    >
                        ...
                        <div class="flex items-end h-full pb-0.5">
                            <UButton
                                color="neutral"
                                variant="soft"
                                class="w-full justify-center h-[38px]"
                                @click="resetFilters"
                            >
                                <Icon
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <UButton
                            color="primary"
                            class="bg-blue-600 hover:bg-blue-700 justify-center font-bold py-3 shadow-sm"
                            @click="fetchData"
                        >
                        ...
                        <UButton
                            color="neutral"
                            class="bg-slate-800 hover:bg-slate-900 text-white justify-center font-bold py-3 shadow-sm"
                            @click="fetchData"
                        >
        ...
        >
            ...
            <UTable v-else :data="suratMasuk" :columns="columns" class="w-full">
                ...
                <template #nomor_surat-cell="{ row }">
                    <div class="flex flex-col">
                        ...
                        <span
                            ...
                            >{{ row.original.klasifikasi_surat }}</span
                        >
                    </div>
                </template>
                ...
                <template #asal_surat-cell="{ row }">
                    <div
                        class="max-w-[200px] truncate font-medium text-slate-700"
                        :title="row.original.asal_surat"
                    >
                ...
                <template #actions-cell="{ row }">
                    <div class="flex items-center gap-1">
                        ...
                        <UTooltip text="Lihat PDF">
                            <UButton
                                variant="ghost"
                                color="primary"
                                size="xs"
                                :disabled="!row.original.file_surat"
                                @click="openGeneratedPdf(row.original)"
                            >
            ...
            <!-- Pagination -->
            <div
                class="flex flex-col sm:flex-row items-center justify-between p-5 border-t border-slate-100 bg-slate-50/30 gap-4"
            >
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="flex items-center gap-1 mx-2">
                        <UButton
                            ...
                            :color="
                                pagination.page === p ? 'primary' : 'neutral'
                            "
            ...
            <template #body>
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <UFormField label="KLASIFIKASI SURAT">
                            <USelect
                    ...
                    <UFormField label="DITUJUKAN KEPADA">
                        <UInput
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center gap-2 text-[#2e7d32]">
                            ...
                            >
                                Teruskan ke Manajemen:
                            </h4>
                        </div>

                        <div
                            class="space-y-2 border border-slate-200 rounded-lg p-1 bg-slate-50"
                        >
                            <div
                            ...
                            >
                                <input
                                    type="checkbox"
                                    :checked="
                                        form.teruskan_ke.includes(staff.name)
                                    "
                    ...
                    <UFormField label="UPLOAD FILE (Optional)">
                        <div
                            class="flex items-center w-full border border-slate-200 rounded-lg overflow-hidden group hover:border-emerald-400 transition-colors"
                        >
                            <label
                                class="bg-slate-50 px-4 py-2 border-r border-slate-200 text-sm font-semibold text-slate-600 cursor-pointer hover:bg-slate-100 shrink-0"
                            >
                                Choose file
                                <input
                                    type="file"
                            ...
                            <span
                                class="px-4 py-2 text-sm text-slate-400 truncate flex-1 bg-white"
                            >
                ...
                <div v-if="selectedSurat" class="space-y-6">
                    ...
                    >
                        ...
                        <div class="space-y-1 text-right">
                            ...
                            <UBadge
                                :color="getStatusColor(selectedSurat.status)"
                                variant="soft"
                    ...
                    <div
                        class="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4 border-t border-slate-100"
                    >
                        <div class="space-y-1">
                            <p
                                class="text-[10px] uppercase tracking-widest text-slate-400 font-bold"
                        ...
                        <div class="space-y-1 text-right">
                            ...
                            <p class="font-medium text-slate-700 font-bold">
                                {{ formatDate(selectedSurat.tanggal_diterima) }}
                            </p>
                        </div>
                        <div class="space-y-1">
                            <p
                            ...
                            <p class="font-medium text-slate-700 uppercase">
                                {{ selectedSurat.klasifikasi_surat }}
                            </p>
                        </div>
                        <div class="space-y-1 text-right">
                            <p
                    ...
                    <div class="space-y-1 pt-4 border-t border-slate-100">
                        ...
                        <p class="font-semibold text-slate-800">
                            {{ selectedSurat.ditujukan_kepada }}
                        </p>
                    </div>
...
import { useSuratMasukPage } from "~/composables/tata-usaha/use-surat-masuk-page";
