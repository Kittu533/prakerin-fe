    ...
    <div class="min-h-screen bg-slate-50">
        <div class="flex">
            ...
            <div class="hidden lg:block sticky top-0 h-screen shrink-0">
                <aside
                    class="w-64 bg-white border-r border-slate-200 flex flex-col h-full"
                >
                    <!-- Logo -->
                    <div
                        class="h-16 flex items-center px-5 border-b border-slate-100"
                    >
                        <img
                    ...
                    <nav class="flex-1 overflow-y-auto py-4 px-3">
                        ...
                        <div class="mt-6 pt-6 border-t border-slate-100">
                            <p
                                class="px-3 mb-2 text-xs font-semibold text-slate-400 uppercase"
                            >
                                Master Data
                            </p>
                            <div class="space-y-1">
